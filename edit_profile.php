<?php
	...
	if (!$picture) $picture = "default_user.png";
...
<div class="profile">
	<div class="profile_component">
		<form class="picture shadow" method="POST" enctype="multipart/form-data" action="./user_process.php">
		...
		<form class="password shadow" method="POST" action="./user_process.php">
	...
	<div class="profile_component">
		<form class="email shadow" method="POST" action="./logout.php">
		...
		<form class="information shadow" method="POST" action="./user_process.php">
